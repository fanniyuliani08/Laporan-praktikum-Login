...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/images/user1.jpg" width="60" height="60" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Fanni Yuliani</div>
                    <div class="email">fanni_yuliani_26rpl@student.smktelkom-mlg.sch.id</div>
                ...
                <ul class="list">
                    ...
                    <li>
                      <a href="<?=base_url('index.php/user/gallery')?>">
                        <i class="fab fa-envira" style="font-size:25px;"></i>
                        <span>Gallery</span>
                      </a>
                    </li>
                    <li>
                      <a href="<?=base_url('index.php/user/event')?>">
                      <i class="fas fa-calendar-week" style="font-size:25px;"></i>
                      <span>Event</span>
                      </a>
                    </li>
                    <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">Fanni - Manusia|Web Developer</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
